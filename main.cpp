...
vector<int> times = {
	...
	2645,80,3483,3659,12,6,99,58,154,1700,284,57962//5959
};

vector<int> qualities = {
	29417,30496,29233,24837,28596,30808,38771,40282,40696,39800,46662,22414,24694,25041,60644,22917,24447,24100,28046,
	25822,29977,66160,46180,42992,48238,25906,43869,23705,72864,72072,15947,7207,7117,20409,50128,91461,17452,14155
};
...
int main(int argc, char *argv[])
{
	if(argc == 8) 
	{
		...
		if(input == "_real") {
			solution = sol.iteration_local_search(time, quality);
		}
		else {
			solution = sol.hill_climbing(time, quality);
		}
